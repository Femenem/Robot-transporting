...
foreach(_expectedTarget mrpt::img)
...
# Create imported target mrpt::img
add_library(mrpt::img SHARED IMPORTED)

set_target_properties(mrpt::img PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/home/matt/Documents/Robot-transporting/workspace/src/van_loading/libs/mrpt/libs/img/include"
  INTERFACE_LINK_LIBRARIES "mrpt::core;mrpt::serialization;mrpt::io;mrpt::math;mrpt::config"
)

# Import target "mrpt::img" for configuration "Release"
...
foreach(_target "mrpt::core" "mrpt::serialization" "mrpt::io" "mrpt::math" "mrpt::config" )
