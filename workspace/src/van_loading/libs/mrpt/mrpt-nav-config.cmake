...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-nav-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-nav_DIR was: ${mrpt-nav_DIR}")
    set(mrpt-nav_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-nav" FORCE)
    include(${MRPT_DIR}/mrpt-nav-config.cmake)
    return()
  endif()
endif()
...
set(_deps "mrpt-maps;mrpt-kinematics")
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-nav-targets.cmake)
