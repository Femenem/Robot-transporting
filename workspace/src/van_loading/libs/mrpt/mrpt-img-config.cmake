...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-img-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-img_DIR was: ${mrpt-img_DIR}")
    set(mrpt-img_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-img" FORCE)
    include(${MRPT_DIR}/mrpt-img-config.cmake)
    return()
  endif()
endif()
...
set(_deps "mrpt-core;mrpt-serialization;mrpt-io;mrpt-math;mrpt-config")
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-img-targets.cmake)
