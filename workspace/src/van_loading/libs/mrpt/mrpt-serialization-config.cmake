...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-serialization-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-serialization_DIR was: ${mrpt-serialization_DIR}")
    set(mrpt-serialization_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-serialization" FORCE)
    include(${MRPT_DIR}/mrpt-serialization-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-serialization-targets.cmake)
