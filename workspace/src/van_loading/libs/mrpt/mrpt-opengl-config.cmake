...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-opengl-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-opengl_DIR was: ${mrpt-opengl_DIR}")
    set(mrpt-opengl_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-opengl" FORCE)
    include(${MRPT_DIR}/mrpt-opengl-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-opengl-targets.cmake)
