...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-detectors-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-detectors_DIR was: ${mrpt-detectors_DIR}")
    set(mrpt-detectors_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-detectors" FORCE)
    include(${MRPT_DIR}/mrpt-detectors-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-detectors-targets.cmake)
