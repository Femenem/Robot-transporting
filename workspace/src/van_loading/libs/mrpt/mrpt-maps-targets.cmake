...
foreach(_expectedTarget mrpt::maps)
...
# Create imported target mrpt::maps
add_library(mrpt::maps SHARED IMPORTED)

set_target_properties(mrpt::maps PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/home/matt/Documents/Robot-transporting/workspace/src/van_loading/libs/mrpt/libs/maps/include"
  INTERFACE_LINK_LIBRARIES "mrpt::obs;mrpt::graphs;mrpt::opengl"
)

# Import target "mrpt::maps" for configuration "Release"
set_property(TARGET mrpt::maps APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(mrpt::maps PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/home/matt/Documents/Robot-transporting/workspace/src/van_loading/libs/mrpt/build/lib/libmrpt-maps.so.1.9.9"
  IMPORTED_SONAME_RELEASE "libmrpt-maps.so.1.9"
  )

# Make sure the targets which have been exported in some other 
# export set exist.
unset(${CMAKE_FIND_PACKAGE_NAME}_NOT_FOUND_MESSAGE_targets)
foreach(_target "mrpt::obs" "mrpt::graphs" "mrpt::opengl" )
