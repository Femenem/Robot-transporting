...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-nanoflann-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-nanoflann_DIR was: ${mrpt-nanoflann_DIR}")
    set(mrpt-nanoflann_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-nanoflann" FORCE)
    include(${MRPT_DIR}/mrpt-nanoflann-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-nanoflann-targets.cmake)
