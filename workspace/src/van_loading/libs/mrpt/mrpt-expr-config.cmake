...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-expr-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-expr_DIR was: ${mrpt-expr_DIR}")
    set(mrpt-expr_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-expr" FORCE)
    include(${MRPT_DIR}/mrpt-expr-config.cmake)
    return()
  endif()
endif()
...
set(_deps "mrpt-system;mrpt-core")
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-expr-targets.cmake)
