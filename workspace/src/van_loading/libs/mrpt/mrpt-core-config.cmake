...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-core-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-core_DIR was: ${mrpt-core_DIR}")
    set(mrpt-core_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-core" FORCE)
    include(${MRPT_DIR}/mrpt-core-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-core-targets.cmake)
