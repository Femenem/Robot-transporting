...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-pbmap-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-pbmap_DIR was: ${mrpt-pbmap_DIR}")
    set(mrpt-pbmap_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-pbmap" FORCE)
    include(${MRPT_DIR}/mrpt-pbmap-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-pbmap-targets.cmake)
