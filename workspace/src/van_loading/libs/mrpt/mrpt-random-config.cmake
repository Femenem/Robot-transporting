...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-random-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-random_DIR was: ${mrpt-random_DIR}")
    set(mrpt-random_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-random" FORCE)
    include(${MRPT_DIR}/mrpt-random-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-random-targets.cmake)
