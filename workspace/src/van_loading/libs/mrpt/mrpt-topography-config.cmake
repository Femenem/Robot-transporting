...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-topography-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-topography_DIR was: ${mrpt-topography_DIR}")
    set(mrpt-topography_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-topography" FORCE)
    include(${MRPT_DIR}/mrpt-topography-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-topography-targets.cmake)
