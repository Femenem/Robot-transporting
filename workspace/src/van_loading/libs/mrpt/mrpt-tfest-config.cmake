...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-tfest-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-tfest_DIR was: ${mrpt-tfest_DIR}")
    set(mrpt-tfest_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-tfest" FORCE)
    include(${MRPT_DIR}/mrpt-tfest-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-tfest-targets.cmake)
