...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-typemeta-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-typemeta_DIR was: ${mrpt-typemeta_DIR}")
    set(mrpt-typemeta_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-typemeta" FORCE)
    include(${MRPT_DIR}/mrpt-typemeta-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-typemeta-targets.cmake)
