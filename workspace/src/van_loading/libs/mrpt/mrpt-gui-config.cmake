...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-gui-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-gui_DIR was: ${mrpt-gui_DIR}")
    set(mrpt-gui_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-gui" FORCE)
    include(${MRPT_DIR}/mrpt-gui-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-gui-targets.cmake)
