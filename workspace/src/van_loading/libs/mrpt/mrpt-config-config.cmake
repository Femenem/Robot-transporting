...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-config-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-config_DIR was: ${mrpt-config_DIR}")
    set(mrpt-config_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-config" FORCE)
    include(${MRPT_DIR}/mrpt-config-config.cmake)
    return()
  endif()
endif()
...
set(_deps "mrpt-core;mrpt-system;mrpt-expr")
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-config-targets.cmake)
