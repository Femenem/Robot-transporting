...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-vision-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-vision_DIR was: ${mrpt-vision_DIR}")
    set(mrpt-vision_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-vision" FORCE)
    include(${MRPT_DIR}/mrpt-vision-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-vision-targets.cmake)
