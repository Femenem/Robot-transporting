...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-system-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-system_DIR was: ${mrpt-system_DIR}")
    set(mrpt-system_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-system" FORCE)
    include(${MRPT_DIR}/mrpt-system-config.cmake)
    return()
  endif()
endif()
...
set(_deps "mrpt-typemeta;mrpt-containers")
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-system-targets.cmake)
