...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-tclap-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-tclap_DIR was: ${mrpt-tclap_DIR}")
    set(mrpt-tclap_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-tclap" FORCE)
    include(${MRPT_DIR}/mrpt-tclap-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-tclap-targets.cmake)
