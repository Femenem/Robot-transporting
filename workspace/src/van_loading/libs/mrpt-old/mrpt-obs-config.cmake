...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-obs-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-obs_DIR was: ${mrpt-obs_DIR}")
    set(mrpt-obs_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-obs" FORCE)
    include(${MRPT_DIR}/mrpt-obs-config.cmake)
    return()
  endif()
endif()
...
set(_deps "mrpt-opengl;mrpt-poses;mrpt-db;mrpt-tfest")
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-obs-targets.cmake)
