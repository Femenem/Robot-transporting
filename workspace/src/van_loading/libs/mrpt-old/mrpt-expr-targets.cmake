...
foreach(_expectedTarget mrpt::expr)
...
# Create imported target mrpt::expr
add_library(mrpt::expr SHARED IMPORTED)

set_target_properties(mrpt::expr PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/home/matt/Documents/Robot-transporting/workspace/src/van_loading/libs/mrpt/libs/expr/include"
  INTERFACE_LINK_LIBRARIES "mrpt::system;mrpt::core"
)
...
foreach(_target "mrpt::system" "mrpt::core" )
