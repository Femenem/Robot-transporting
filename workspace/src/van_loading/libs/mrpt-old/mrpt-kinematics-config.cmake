...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-kinematics-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-kinematics_DIR was: ${mrpt-kinematics_DIR}")
    set(mrpt-kinematics_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-kinematics" FORCE)
    include(${MRPT_DIR}/mrpt-kinematics-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-kinematics-targets.cmake)
