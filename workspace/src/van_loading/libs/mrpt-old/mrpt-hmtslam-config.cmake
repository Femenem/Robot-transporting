...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-hmtslam-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-hmtslam_DIR was: ${mrpt-hmtslam_DIR}")
    set(mrpt-hmtslam_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-hmtslam" FORCE)
    include(${MRPT_DIR}/mrpt-hmtslam-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-hmtslam-targets.cmake)
