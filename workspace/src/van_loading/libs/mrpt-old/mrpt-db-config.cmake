...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-db-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-db_DIR was: ${mrpt-db_DIR}")
    set(mrpt-db_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-db" FORCE)
    include(${MRPT_DIR}/mrpt-db-config.cmake)
    return()
  endif()
endif()
...
set(_deps "mrpt-core;mrpt-serialization;mrpt-system")
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-db-targets.cmake)
