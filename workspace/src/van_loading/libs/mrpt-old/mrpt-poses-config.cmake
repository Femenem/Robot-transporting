...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-poses-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-poses_DIR was: ${mrpt-poses_DIR}")
    set(mrpt-poses_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-poses" FORCE)
    include(${MRPT_DIR}/mrpt-poses-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-poses-targets.cmake)
