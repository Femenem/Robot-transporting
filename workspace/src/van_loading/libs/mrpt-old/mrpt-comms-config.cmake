...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-comms-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-comms_DIR was: ${mrpt-comms_DIR}")
    set(mrpt-comms_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-comms" FORCE)
    include(${MRPT_DIR}/mrpt-comms-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-comms-targets.cmake)
