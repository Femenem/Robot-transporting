...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-containers-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-containers_DIR was: ${mrpt-containers_DIR}")
    set(mrpt-containers_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-containers" FORCE)
    include(${MRPT_DIR}/mrpt-containers-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-containers-targets.cmake)
