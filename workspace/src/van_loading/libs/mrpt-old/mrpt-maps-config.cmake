...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-maps-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-maps_DIR was: ${mrpt-maps_DIR}")
    set(mrpt-maps_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-maps" FORCE)
    include(${MRPT_DIR}/mrpt-maps-config.cmake)
    return()
  endif()
endif()
...
set(_deps "mrpt-obs;mrpt-graphs;mrpt-opengl")
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-maps-targets.cmake)
