...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-graphslam-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-graphslam_DIR was: ${mrpt-graphslam_DIR}")
    set(mrpt-graphslam_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-graphslam" FORCE)
    include(${MRPT_DIR}/mrpt-graphslam-config.cmake)
    return()
  endif()
endif()
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-graphslam-targets.cmake)
