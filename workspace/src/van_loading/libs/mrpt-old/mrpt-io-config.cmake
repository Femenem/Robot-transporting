...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-io-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-io_DIR was: ${mrpt-io_DIR}")
    set(mrpt-io_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-io" FORCE)
    include(${MRPT_DIR}/mrpt-io-config.cmake)
    return()
  endif()
endif()
...
set(_deps "mrpt-core;mrpt-system")
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-io-targets.cmake)
