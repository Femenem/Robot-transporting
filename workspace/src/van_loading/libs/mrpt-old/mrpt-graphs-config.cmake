...
if (NOT "${MRPT_DIR}" STREQUAL "")
  ...
  if ((EXISTS "${MRPT_DIR}/mrpt-graphs-config.cmake") AND (NOT "${this_dir}" STREQUAL "${user_mrpt_dir}"))
    message("mrpt-graphs_DIR was: ${mrpt-graphs_DIR}")
    set(mrpt-graphs_DIR "${MRPT_DIR}" CACHE PATH "Path to mrpt-graphs" FORCE)
    include(${MRPT_DIR}/mrpt-graphs-config.cmake)
    return()
  endif()
endif()
...
set(_deps "mrpt-opengl;mrpt-poses")
...
include(${CMAKE_CURRENT_LIST_DIR}/mrpt-graphs-targets.cmake)
