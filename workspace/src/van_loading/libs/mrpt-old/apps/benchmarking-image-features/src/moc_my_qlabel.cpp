...
QT_MOC_LITERAL(3, 25, 9), // "Mouse_Pos"
QT_MOC_LITERAL(4, 35, 10) // "Mouse_Left"

    },
    "my_qlabel\0Mouse_Pressed\0\0Mouse_Pos\0"
    "Mouse_Left"
};
...
void my_qlabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (my_qlabel::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&my_qlabel::Mouse_Pressed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (my_qlabel::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&my_qlabel::Mouse_Pos)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (my_qlabel::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&my_qlabel::Mouse_Left)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject my_qlabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_my_qlabel.data,
      qt_meta_data_my_qlabel,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 1
void my_qlabel::Mouse_Pos()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void my_qlabel::Mouse_Left()
{
