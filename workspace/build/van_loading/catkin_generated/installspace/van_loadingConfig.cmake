...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'mam107 <mam107@aber.ac.uk>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'van_loading' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/matt/Documents/Robot-transporting/workspace/install/${idir}'.  ${_report}")
    endif()
    _list_append_unique(van_loading_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "van_loading")
...
set(van_loading_EXPORTED_TARGETS "")
